...
// ── DATA ───────────────────────────────────────────
const SONGS_DATA = [
  { id: 'bad-wte', title: 'bad', artist: 'wave to earth', genre: 'rb', duration: '3:20', plays: '150M', art: 'assets/flaws.png' },
  { id: 'peach-eyes-wte', title: 'peach eyes', artist: 'wave to earth', genre: 'rb', duration: '3:12', plays: '95M', art: 'assets/flaws.png' },
  { id: 'mantra-jennie', title: 'Mantra', artist: 'JENNIE', genre: 'pop', duration: '3:15', plays: '200M', art: 'assets/ruby.png' },
  { id: 'seoul-city-jennie', title: 'Seoul City', artist: 'JENNIE', genre: 'pop', duration: '3:45', plays: '120M', art: 'assets/ruby.png' },
  { id: 'golden-hour', title: 'Golden Hour', artist: 'JVKE', genre: 'rb', duration: '3:29', plays: '980M', art: 'assets/golden_hour.png' },
  { id: 'anti-hero', title: 'Anti-Hero', artist: 'Taylor Swift', genre: 'pop', duration: '3:20', plays: '1.2B', art: 'assets/midnights.jpg' },
  { id: 'flowers', title: 'Flowers', artist: 'Miley Cyrus', genre: 'pop', duration: '3:20', plays: '1.5B', art: 'assets/flowers.png' },
  { id: 'creepin', title: 'Creepin\'', artist: 'Metro Boomin', genre: 'hiphop', duration: '3:41', plays: '800M', art: 'assets/creepin.jpg' },
  ...
  { id: 'paint-the-town', title: 'Paint The Town Red', artist: 'Doja Cat', genre: 'hiphop', duration: '3:51', plays: '800M', art: 'assets/paint_the_town_red.png' },
  ...
  { id: 'sunny-days', title: 'sunny days', artist: 'wave to earth', genre: 'rb', duration: '3:45', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'evening-glow', title: 'evening glow', artist: 'wave to earth', genre: 'rb', duration: '4:01', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'pink-horizon', title: 'pink horizon', artist: 'wave to earth', genre: 'rb', duration: '3:58', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'calla', title: 'calla', artist: 'wave to earth', genre: 'rb', duration: '3:15', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'love-wte', title: 'love.', artist: 'wave to earth', genre: 'rb', duration: '4:20', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'homesick', title: 'homesick', artist: 'wave to earth', genre: 'rb', duration: '3:55', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'dried-flower', title: 'dried flower', artist: 'wave to earth', genre: 'rb', duration: '3:40', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'sunburn', title: 'sunburn', artist: 'wave to earth', genre: 'rb', duration: '3:25', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'akira', title: 'akira', artist: 'wave to earth', genre: 'rb', duration: '4:10', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'nouvelle-vague', title: 'nouvelle vague', artist: 'wave to earth', genre: 'rb', duration: '3:50', art: 'assets/flaws.png', hideFromCatalog: true },
  { id: 'so-real', title: 'so real', artist: 'wave to earth', genre: 'rb', duration: '3:35', art: 'assets/flaws.png', hideFromCatalog: true },

  // RUBY Tracks (Hidden)
  { id: 'intro-jane', title: 'Intro: JANE', artist: 'JENNIE', genre: 'pop', duration: '1:45', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'like-jennie', title: 'like JENNIE', artist: 'JENNIE', genre: 'pop', duration: '3:20', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'start-a-war', title: 'start a war', artist: 'JENNIE', genre: 'pop', duration: '3:10', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'handlebars', title: 'Handlebars', artist: 'JENNIE', genre: 'pop', duration: '3:55', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'with-the-ie', title: 'with the IE', artist: 'JENNIE', genre: 'pop', duration: '3:05', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'extral', title: 'ExtraL', artist: 'JENNIE', genre: 'pop', duration: '3:40', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'love-hangover', title: 'Love Hangover', artist: 'JENNIE', genre: 'pop', duration: '3:50', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'zen', title: 'ZEN', artist: 'JENNIE', genre: 'pop', duration: '3:25', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'damn-right', title: 'Damn Right', artist: 'JENNIE', genre: 'pop', duration: '4:05', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'fts', title: 'F.T.S.', artist: 'JENNIE', genre: 'pop', duration: '3:10', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'filter-jennie', title: 'Filter', artist: 'JENNIE', genre: 'pop', duration: '3:30', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'starlight', title: 'Starlight', artist: 'JENNIE', genre: 'pop', duration: '3:20', art: 'assets/ruby.png', hideFromCatalog: true },
  { id: 'twin', title: 'twin', artist: 'JENNIE', genre: 'pop', duration: '3:15', art: 'assets/ruby.png', hideFromCatalog: true },

  // SOUR Tracks (Hidden)
  { id: 'brutal', title: 'brutal', artist: 'Olivia Rodrigo', genre: 'pop', duration: '2:23', art: 'assets/sour.jpg', hideFromCatalog: true },
  { id: 'traitor-album', title: 'traitor', artist: 'Olivia Rodrigo', genre: 'pop', duration: '3:49', art: 'assets/sour.jpg', hideFromCatalog: true },
  { id: 'drivers license-album', title: 'drivers license', artist: 'Olivia Rodrigo', genre: 'pop', duration: '4:02', art: 'assets/sour.jpg', hideFromCatalog: true },
  { id: 'deja-vu', title: 'deja vu', artist: 'Olivia Rodrigo', genre: 'pop', duration: '3:35', art: 'assets/sour.jpg', hideFromCatalog: true },
  { id: 'good-4-u-album', title: 'good 4 u', artist: 'Olivia Rodrigo', genre: 'pop', duration: '2:58', art: 'assets/sour.jpg', hideFromCatalog: true },
  { id: 'happier', title: 'happier', artist: 'Olivia Rodrigo', genre: 'pop', duration: '2:55', art: 'assets/sour.jpg', hideFromCatalog: true },

  // SOS Tracks (Hidden)
  { id: 'sos-track', title: 'SOS', artist: 'SZA', genre: 'rb', duration: '1:57', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'kill-bill-album', title: 'Kill Bill', artist: 'SZA', genre: 'rb', duration: '2:33', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'seek-destroy', title: 'Seek & Destroy', artist: 'SZA', genre: 'rb', duration: '3:23', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'low', title: 'Low', artist: 'SZA', genre: 'rb', duration: '3:01', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'blind', title: 'Blind', artist: 'SZA', genre: 'rb', duration: '2:30', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'snooze-album', title: 'Snooze', artist: 'SZA', genre: 'rb', duration: '3:21', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'shirt-album', title: 'Shirt', artist: 'SZA', genre: 'rb', duration: '3:01', art: 'assets/sos.jpg', hideFromCatalog: true },
  { id: 'i-hate-u', title: 'I Hate U', artist: 'SZA', genre: 'rb', duration: '2:54', art: 'assets/sos.jpg', hideFromCatalog: true },
...
const ALBUMS_DATA = [
  ...
  {
    id: 'midnights-album', title: 'Midnights', artist: 'Taylor Swift',
    released: '21 de outubro de 2022', duration: '44:02',
    art: 'assets/midnights.jpg',
    tracks: [{ title: 'Anti-Hero', duration: '3:20' }]
  },
  {
    id: 'lover-album', title: 'Lover', artist: 'Taylor Swift',
    released: '23 de agosto de 2019', duration: '61:48',
    art: 'assets/lover.png',
    tracks: [{ title: 'Cruel Summer', duration: '2:58' }]
  },
  {
    id: 'golden-album', title: 'GOLDEN', artist: 'Jung Kook',
    released: '3 de novembro de 2023', duration: '32:10',
    art: 'assets/golden.png',
    tracks: [{ title: 'Seven', duration: '3:04' }]
  },
  {
    id: 'starboy-album', title: 'Starboy', artist: 'The Weeknd',
    released: '25 de novembro de 2016', duration: '68:40',
    art: 'assets/starboy.png',
    tracks: [{ title: 'Die For You', duration: '3:52' }]
  },
  {
    id: 'her-loss-album', title: 'Her Loss', artist: 'Drake & 21 Savage',
    released: '4 de novembro de 2022', duration: '60:33',
    art: 'assets/her_loss.jpg',
    tracks: [{ title: 'Rich Flex', duration: '3:59' }]
  },
  {
    id: 'renaissance-album', title: 'RENAISSANCE', artist: 'Beyoncé',
    released: '29 de julho de 2022', duration: '62:14',
    art: 'assets/renaissance.png',
    tracks: [{ title: 'Cuff It', duration: '3:45' }]
  },
  {
  ...
  {
    id: 'short-n-sweet-album', title: 'Espresso', artist: 'Sabrina Carpenter',
    released: '2024', duration: '2:55',
    art: 'assets/espresso.png',
    tracks: [{ title: 'Espresso', duration: '2:55' }]
  },
  {
    id: 'rave-roses-album', title: 'Rave & Roses', artist: 'Rema',
    released: '25 de março de 2022', duration: '59:12',
    art: 'assets/calm_down.jpg',
    tracks: [{ title: 'Calm Down', duration: '3:59' }]
  },
  {
    id: 'endless-summer-album', title: 'Endless Summer Vacation', artist: 'Miley Cyrus',
    released: '10 de março de 2023', duration: '43:10',
    art: 'assets/endless_summer.jpg',
    tracks: [{ title: 'Flowers', duration: '3:20' }]
  },
  {
    id: 'heroes-villains-album', title: 'Heroes & Villains', artist: 'Metro Boomin',
    released: '2 de dezembro de 2022', duration: '48:12',
    art: 'assets/creepin.jpg',
    tracks: [{ title: 'Creepin\'', duration: '3:41' }]
  }
];

function getArtBg(art) {
  if (art && art.startsWith('http')) return `url('${art}')`;
  if (art && art.startsWith('assets/')) return `url('${art}')`;
  return art;
}
...
const FULL_LYRICS = {
  ...
  'Feel It': [
    ...
    "And now I can feel it (oh, it got me feeling)",
    "It's like, ooh",
    "Take away the pain, baby, I'm healing (baby, I'm healing)",
    "Baby, I'm healing (yeah, yeah, yeah, yeah)",
    "I don't need anything more (oh)",
    "Be the wave, I'll be the shore (oh)",
    "Crashing all over me, I want you (oh, yeah, ah)",
...
function renderCatalog(filter = 'all', targetGrid = tracksGrid) {
  ...
  SONGS_DATA.forEach((song, index) => {
    ...
    card.innerHTML = `
      <div class="track-art">
        <img src="${song.art}" alt="${song.title}" class="track-img" style="width: 100%; height: 100%; object-fit: cover;">
        <!-- Top Actions -->
...
function renderAlbums() {
  ...
  const allowedIds = ['flaws-and-all', 'ruby-jennie', 'sour-album', 'sos-album'];
  const filtered = ALBUMS_DATA.filter(a => allowedIds.includes(a.id));
  ...
  filtered.forEach(album => {
    ...
    card.innerHTML = `
      <div class="album-art" style="aspect-ratio: 1; border-radius: 16px; overflow: hidden; margin-bottom: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
        <img src="${album.art}" alt="${album.title}" class="album-img" style="width: 100%; height: 100%; object-fit: cover;">
      </div>
  ...
  modalContent.innerHTML = `
    <div class="album-detail-view" style="padding:20px; color:var(--txt);">
      ...
      <div class="album-detail-header" style="display:flex; gap:25px; align-items:flex-end; margin-bottom:30px; flex-wrap:wrap;">
        <div class="album-detail-art" style="width:180px; height:180px; border-radius:20px; box-shadow:0 25px 50px rgba(0,0,0,0.4); flex-shrink:0; overflow: hidden;">
          <img src="${album.art}" alt="${album.title}" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
...
function checkAuthStatus() {
  const isLoggedIn = localStorage.getItem('bv_isLoggedIn') === 'true';
  const userData = JSON.parse(localStorage.getItem('bv_user') || '{}');
    ...
    const userDisplay = `
      <div class="user-profile-pill" id="userProfilePill">
        ...
        <button class="logout-btn" onclick="logout()" title="Sair">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 17l5-5-5-5M21 12H9"/></svg>
        </button>
      </div>
    `;
    
    if (navCta) {
      navCta.outerHTML = userDisplay;
    }
    
    if (mobileCta) {
      mobileCta.parentElement.innerHTML = `
        <div class="mobile-user-profile">
          <div class="mobile-user-info">
            <div class="user-avatar">${userData.name.charAt(0).toUpperCase()}</div>
            <strong>${userData.name}</strong>
          </div>
          <a href="#" onclick="logout()" class="mobile-link logout-link">Sair da Conta</a>
        </div>
      `;
    }
  }
...
window.logout = function() {
  localStorage.removeItem('bv_isLoggedIn');
...
function handleModalAuth(type) {
  ...
  if (type === 'signup') {
    nameInput = document.querySelector('#modalSignupView input[type="text"]');
    emailInput = document.querySelector('#modalSignupView input[type="email"]');
  } else {
    emailInput = document.querySelector('#modalLoginView input[type="email"]');
  }

  const name = nameInput ? nameInput.value : (emailInput ? emailInput.value.split('@')[0] : "Usuário");
  ...
  localStorage.setItem('bv_isLoggedIn', 'true');
...
window.toggleModalAuth = toggleModalAuth;
window.handleModalAuth = handleModalAuth;

// Re-check auth on script load
checkAuthStatus();
